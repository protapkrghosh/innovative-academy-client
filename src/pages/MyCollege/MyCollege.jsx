...
const MyCollege = () => {
  ...
  const addReview = (event) => {
    ...
    axios
      .post(
        `https://edumind-server.vercel.app/addReview/${collegeName}`,
        newReview
      )
      .then((res) => {
  ...
  useEffect(() => {
    if (user) {
      axios
        .get(
          `https://edumind-server.vercel.app/student/${user?.displayName}`
        )
        .then((res) => {
          setStudent(res.data);
          console.log(student);
  ...
  useEffect(() => {
    ...
    if (user && student && student.collegeId) {
      axios
        .get(
          `https://edumind-server.vercel.app/myCollege/${student.collegeId}`
        )
        .then((res) => {
          setCollege(res.data);
          console.log(res.data);
